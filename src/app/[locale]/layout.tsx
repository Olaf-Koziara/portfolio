      ...
      <body className="antialiased">
        <ThemeProvider>
          <NextIntlClientProvider messages={messages}>
            ...
            <a
              href="#main-content"
              className="fixed -top-20 left-4 z-[100] px-4 py-2 bg-accent text-white rounded-lg transition-all focus:top-4 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-accent"
            >
              {t("skipToContent")}
            </a>

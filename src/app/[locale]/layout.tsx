      ...
      <body className="antialiased">
        <ThemeProvider>
          <NextIntlClientProvider messages={messages}>
            <a
              href="#main-content"
              className="fixed -top-20 focus:top-4 left-4 z-[100] px-6 py-3 bg-accent text-white rounded-xl font-medium transition-all duration-300 shadow-xl focus:outline-none focus-visible:ring-2 focus-visible:ring-accent-hover"
            >
              {t("skipToContent")}
            </a>
            {/* Navigation */}

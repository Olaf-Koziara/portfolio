      ...
      <body className="antialiased">
        <ThemeProvider>
          <NextIntlClientProvider messages={messages}>
            ...
            <a
              href="#main-content"
              className="fixed -top-20 left-4 z-[100] px-4 py-2 bg-accent text-white rounded-lg transition-all duration-300 focus:top-4 outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2"
            >
              {t("skipToContent")}
            </a>

      ...
      <body className="antialiased">
        <ThemeProvider>
          <NextIntlClientProvider messages={messages}>
            <a
              href="#main-content"
              className="fixed -top-20 left-4 z-[100] bg-accent text-white px-6 py-3 rounded-xl font-medium transition-all focus:top-4 outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2"
            >
              {t("skipToContent")}
            </a>
            {/* Navigation */}

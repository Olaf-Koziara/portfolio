      ...
      <body className="antialiased">
        <ThemeProvider>
          <NextIntlClientProvider messages={messages}>
            ...
            <a
              href="#main-content"
              className="fixed -top-20 left-4 z-[100] px-6 py-3 bg-accent text-white rounded-xl shadow-2xl outline-hidden focus:top-4 focus:ring-4 focus:ring-accent/50 transition-all no-underline font-medium"
            >
              {t("skipToContent")}
            </a>

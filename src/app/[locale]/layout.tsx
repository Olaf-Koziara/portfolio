  ...
  return (
    <html lang={locale} suppressHydrationWarning>
      <body className="antialiased">
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-[100] focus:px-6 focus:py-3 focus:bg-accent focus:text-white focus:rounded-xl focus:shadow-2xl focus:outline-hidden transition-all"
        >
          {t("skipToContent")}
        </a>
        <ThemeProvider>

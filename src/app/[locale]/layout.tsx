      ...
      <body className="antialiased">
        <ThemeProvider>
          <NextIntlClientProvider messages={messages}>
            ...
            <a
              href="#main-content"
              className="fixed -top-20 left-4 z-[100] bg-accent text-white px-6 py-3 rounded-xl transition-all duration-300 focus:top-4 outline-none focus-visible:ring-2 focus-visible:ring-accent"
            >
              {t("skipToContent")}
            </a>

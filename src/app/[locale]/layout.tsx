      ...
      <body className="antialiased">
        <ThemeProvider>
          <NextIntlClientProvider messages={messages}>
            ...
            <a
              href="#main-content"
              className="fixed -top-20 left-4 z-[100] bg-accent text-white px-6 py-3 rounded-lg transition-all duration-300 focus:top-4 focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2"
            >
              {t("skipToContent")}
            </a>
